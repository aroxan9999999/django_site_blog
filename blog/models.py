...
class Post(models.Model):
    ...
    photo = models.ImageField(upload_to="blacpink/")
...
class Like(models.Model):
    _like = models.ForeignKey("auth.USER", on_delete=models.PROTECT, blank=True, null=True, related_name='_like')
    _dislike = models.ForeignKey("auth.USER", on_delete=models.PROTECT, blank=True, null=True, related_name="_dislike")
    post = models.ForeignKey(Post, on_delete=models.PROTECT, blank=True, null=True, related_name="пост")
